...
if &t_Co > 255
   ...
   hi Constant        ctermfg=146               cterm=bold
   ...
   " Variable?
   hi Identifier      ctermfg=201 cterm=bold
   ...
   hi Search          ctermfg=255 ctermbg=196
   ...
   " statements like print, scalar, exit
   ...
   hi Todo            ctermfg=255 ctermbg=130   cterm=bold
